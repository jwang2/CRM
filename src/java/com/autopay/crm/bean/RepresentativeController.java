...
public class RepresentativeController implements Serializable {
    ...
    private Representative current;
    private DataModel items = null;
    @EJB
    private com.autopay.crm.session.RepresentativeFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Representative) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle_new").getString("RepresentativeCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle_new").getString("RepresentativeUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle_new").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle_new").getString("RepresentativeDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle_new").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Representative getRepresentative(java.lang.Long id) {
    ...
    public static class RepresentativeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Representative) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Representative.class.getName());
            }
        }
    }
}
